...
params.qal_intensity_method = "top3_sum"  // Method to calculate the quantitative value of the individual XICs. Only available options are "top3_sum", "top3_mean", "maximum" and "sum".. See the python script for more details.
